/**
  ******************************************************************************
  * @file      startup_stm32mp257xx_m33.s
...
g_pfnVectors:
  ...
  /*******************************************************************************/
    ...
    .word   CRYP1_IRQHandler            /* Crypto1 interrupt */
#else /* STM32MP257Cxx */
    .word   0
...
#if defined(STM32MP257Cxx)
    .word   CRYP2_IRQHandler            /* Crypto2 interrupt */
#else /* STM32MP257Cxx */
    .word   0
#endif /* else STM32MP257Cxx */
    ...
    .word   0
    .word   ETHSW_IRQHandler            /* Ethernet Switch global interrupt */
    .word   ETHSW_MSGBUF_IRQHandler     /* Ethernet ACM Message buffer interrupt */
    .word   ETHSW_FSC_IRQHandler        /* Ethernet ACM Scheduler interrupt */
